...
const DURATION = 400;
export default function MenNavbar({navigation}) {
  OnPressHandlerWomen = () => {
        ...
        <TouchableOpacity>
          <View
            ...
            <MaterialCommunityIcons
              ...
              size={20}
            />
            <Text style={{color: '#fff'}}>MEN'S</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity onPress={OnPressHandlerWomen}>
          <View
            style={{
              backgroundColor: '#fff',
              padding: 10,
            ...
            <MaterialCommunityIcons
              ...
              size={20}
            />
            <Text style={{color: '#000'}}>WOMEN'S</Text>
          </View>
        </TouchableOpacity>
